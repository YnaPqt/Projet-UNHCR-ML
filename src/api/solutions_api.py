...
> Les données relatives aux solutions recensent les réfugiés et les personnes déplacées à l’intérieur de leur propre pays qui ont bénéficié d’une solution durable.

Colonnes :

* Réfugiés rapatriés
* Personnes déplacées internes retournées
* Arrivées dans le cadre d’une réinstallation
* Naturalisations
...
df.to_csv(
   RAW_DATA_DIR /  "data_solutions_depuis_2000.csv",
    index=False,
    encoding="utf-8-sig"
)