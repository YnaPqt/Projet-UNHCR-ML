"""
 Asylum Applications Data / Demandes d'asile

> Demandes d’asile déposées par année, ainsi que par pays d’asile et pays d’origine. 
Ces demandes sont soumises par des personnes necesitant une protection internationale.
...
df.to_csv(
    RAW_DATA_DIR / "demandes_asile_depuis_2000.csv",
    index=False,
    encoding="utf-8-sig"
)