"""
Demographics Data
> Permet de récupérer des données démographiques disponibles. Le UNHCR collecte ces informations pour toutes les catégories de population, ainsi que pour deux solutions durables : le retour des personnes déplacées à l’intérieur de leur propre pays (IDP) et le rapatriement des réfugiés.
...
df.to_csv(
   RAW_DATA_DIR /  "demographie_depuis_2000.csv",
    index=False,
    encoding="utf-8-sig"
)
