...
> Permet de récupérer les données sur les personnes déplacées à l’intérieur de leur propre pays en raison de conflits et de violences. 
Ces données sont produites par l’Observatoire des situations de déplacement interne, également appelé Internal Displacement Monitoring Centre (IDMC).
...
df.to_csv(
    RAW_DATA_DIR / "data_idmc_depuis_2000.csv",
    index=False,
    encoding="utf-8-sig"
)
